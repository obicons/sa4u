...
int main(int argc, char **argv) {
        ...
        options.add_options()
                ...
                ("m,message-definition", 
                 "path to XML file containing the message spec: Supported specs are MavLink and LMCP",
                 cxxopts::value<string>())
                ("p,prior-types",
		...
		case MAVLINK:
			...
			type_to_field_to_unit = get_type_to_field_to_unit(doc, unitname_to_id, num_units);
			break;
		case LMCP:
			/*
			type_to_semantic = get_types_to_frame_field(doc);
