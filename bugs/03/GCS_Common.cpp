...
//     uint32_t corrected_ms;
//     corrected_ms = correct_offboard_timestamp_usec_to_ms(m.time_usec, PAYLOAD_SIZE(chan, LANDING_TARGET));
...
uint32_t GCS_MAVLINK::correct_offboard_timestamp_usec_to_ms(uint64_t offboard_usec, uint16_t payload_size)
{
    ...
    uint64_t corrected_us;
    corrected_us = lag_correction.correct_offboard_timestamp_usec(offboard_usec, local_us);
